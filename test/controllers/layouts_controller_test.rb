...
class LayoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create layout" do
    assert_difference('Layout.count') do
      post layouts_url, params: { layout: { content: @layout.content, name: @layout.name, site: @layout.site } }
    end
  ...
  test "should update layout" do
    patch layout_url(@layout), params: { layout: { content: @layout.content, name: @layout.name, site: @layout.site } }
