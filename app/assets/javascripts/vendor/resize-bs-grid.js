(function($, window, document, undefined) {
    ...
    $.widget('ce.resizableGrid', {
        ...
        _setColumnSize: function(column, size) {
            column.toggleClass([['col', this._getColumnSize(column)].join('-'), ['col', size].join('-')].join(' '));
        },
        ...
        _setColumnOffset: function(column, offset) {
            ...
            if ((currentColumnOffset = this._getColumnOffset(column)) !== undefined) {
                toggleClasses.push(['col', 'offset', currentColumnOffset].join('-'));
            }

            toggleClasses.push(['col', 'offset', offset].join('-'));
